...
4. **Open an issue** with the "New CAN ID" template, or a pull request that updates:
   - `docs/can-id-reference.md` (add it to the "Decoded" table)
...
Please include your vehicle details: model year, engine, body (van, chassis cab, motorhome conversion), and how you verified the value on the real vehicle. Only verified decodings are merged.
